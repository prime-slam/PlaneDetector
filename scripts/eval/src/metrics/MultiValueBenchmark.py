...
from src.metrics.Label import UNSEGMENTED_LABEL
...
def __multi_value_benchmark(
    ...
    if UNSEGMENTED_LABEL in plane_predicted_dict:
        del plane_predicted_dict[UNSEGMENTED_LABEL]
    if UNSEGMENTED_LABEL in plane_gt_dict:
        del plane_gt_dict[UNSEGMENTED_LABEL]
