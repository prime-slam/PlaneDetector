...
annotators = {"cvat": CVATAnnotator, "sse": SSEAnnotator}

algos = {"RANSAC-o3d": O3DRansacDetector, "DDPFF": DDPFFDetector}

metrics = {"iou": IoUBenchmark, "dice": DiceBenchmark, "classic": MultiValueBenchmark}
